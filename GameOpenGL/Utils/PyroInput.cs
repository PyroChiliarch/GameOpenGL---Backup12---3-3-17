...
/// <summary>
/// Abstration of OpenTK.Input
/// Allows checking of whether buttons are pressed released or held down
/// 
/// To Use:
/// Call Initialise at setup
/// Call Update every Game Logic Frame (Whenever game is updated)
/// 
/// Check for keys using KeyPress, KeyRelease etc
/// 
/// </summary>
...
namespace PyroInput
{
    class Input
    {
        ...
        public static void Initialise(GameWindow game)
        {
            ...
            game.Mouse.ButtonDown += Game_MouseDown;
            game.Mouse.ButtonUp += Game_MouseUp;
        }
        ...
        //Inquiries about keyboard status are to be directed here
        ...
        //Inquiries about mouse status are to be directed here
